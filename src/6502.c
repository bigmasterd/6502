...
{
    if (flag == 1)
        P = P | 0b01000000; // V = 1 => overflow occured
    else
        P = P & 0b10111111;
}
...
{
    if (reg == 0)
        P = P | 0b00000010; // register is zero => set Z to 1
    else
        P = P & 0b11111101; // register is non zero => set Z to 0
}
...
int main(int argc, char *argv[])
{
    ...
    while (running)
    {
        ...
        */
        ...
        case BNE_REL:
            bne_rel();
            break; // branch to PC+operand if Z == 0
